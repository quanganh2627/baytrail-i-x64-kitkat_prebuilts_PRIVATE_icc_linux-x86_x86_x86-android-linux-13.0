...
#if (!defined (__linux__) && !defined(__APPLE__) && !defined(__FreeBSD__) && !defined(__QNX__) && !defined(__VXWORKS__)) || defined (__PURE_INTEL_C99_HEADERS__)
...
#endif /* (!__linux__ && !__APPLE__ && !__FreeBSD__ && !__QNX__ && !__VXWORKS__) || __PURE_INTEL_C99_HEADERS__ */


#if !(defined(__unix__) || defined(__APPLE__) || defined(__QNX__) || defined(__VXWORKS__)) /* We need to define FP_ILOGB0, FP_ILOGBNAN */
...
#endif  /* __unix__ && !__APPLE__ && !__QNX__ & !__VXWORKS__ */
...
#if defined(__APPLE__) || (!defined(__QNX__) && !defined(__VXWORKS__) && !(defined(__unix__) && defined(__USE_ISOC99)))
...
#if !defined(__APPLE__) && !defined(__QNX__) && !defined(__VXWORKS__) && (!defined(__unix__) || !defined (__USE_ISOC99) || (defined (__USE_ISOC99) && !defined (__USE_MISC) && !defined (__USE_XOPEN_EXTENDED)))
...
#if (!defined(__unix__) && !defined(__QNX__) && !defined(__VXWORKS__) && !defined(__APPLE__)) || defined(__PURE_INTEL_C99_HEADERS__)
...
#if (!defined (__APPLE__) && !defined(__QNX__) && !defined(__VXWORKS__) && !(defined(__unix__) && defined(__USE_ISOC99))) || defined(__PURE_INTEL_C99_HEADERS__)
...
#if !(defined(__APPLE__) && !defined(__QNX__) && !defined(__VXWORKS__) && !defined(_ANSI_SOURCE)) && !defined(__unix__)
...
#if !defined(__linux__) && !defined(__APPLE__) && !defined(__QNX__) && !defined(__VXWORKS__) && !defined(__NetBSD__)
...
#if (!defined(__unix__) && !defined(__APPLE__) && !defined(__QNX__) && !defined(__VXWORKS__)) || !defined(__MATH_H_INCLUDED)
...
#endif /* (!__unix__ && !__APPLE__ && !__QNX__ & !__VXWORKS__) || !__MATH_H_INCLUDED */
